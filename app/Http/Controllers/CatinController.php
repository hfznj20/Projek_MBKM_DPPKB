...
class CatinController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'indeks_massa_tubuh' => 'required|decimal:2',
        ...
        Catin::create([
            ...
            'catin_wanita_merokok_terpapar' => $request->catin_wanita_merokok_terpapar,
            'catin_pria_merokok_terpapar' => $request->catin_pria_merokok_terpapar,
