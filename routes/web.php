...
use App\Http\Controllers\MapsebaranController;
...
Route::post('/catin/create', [CatinController::class, 'store'])->name('catin.store');
Route::post('/catin/storePasanganBaru', [CatinController::class, 'storePasanganBaru'])->name('catin.storePasanganBaru');
...
Route::get('wilayah/{namaKecamatan}', [MapsebaranController::class, 'show']);
Route::get('Sebaran/{nama}', [MapsebaranController::class, 'show']);

Route::get('/sebaran/{kecamatan}', function ($kecamatan) {
    return Inertia::render('Sebaran/' . ucfirst($kecamatan));
});

Route::get('/sebaran/ujung', function () {
    return Inertia::render('Sebaran/Ujung');
});

Route::get('/api/sebaran/ujung', [MapsebaranController::class, 'getSebaranUjung']);
Route::get('/api/baduta/umur', [MapsebaranController::class, 'getUmurStatistik']);
Route::get('/api/stunting-per-kelurahan', [MapsebaranController::class, 'getStuntingPerKelurahan']);
Route::get('/api/bumil/ttd-ujung', [MapsebaranController::class, 'getTTDStatistik']);
Route::get('/api/statistik/ibu-anak-lebih-2', [MapsebaranController::class, 'getIbuAnakLebihDari2']);
Route::get('/api/akses-air-minum-layak', [MapsebaranController::class, 'getAksesAirMinumLayak']);
