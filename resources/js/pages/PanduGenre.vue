...
// Data untuk tabel
const tableData = ref([
    { nik: '1234567890', nama: 'John Doe', kecamatan: 'Kecamatan A', kelurahan: 'Kelurahan A' },
    { nik: '9876543210', nama: 'Jane Smith', kecamatan: 'Kecamatan B', kelurahan: 'Kelurahan B' },
    { nik: '1122334455', nama: 'Budi Santoso', kecamatan: 'Kecamatan C', kelurahan: 'Kelurahan C' },
]);
...
const filteredTableData = computed(() => {
    return tableData.value.filter(item =>
        ...
        item.kelurahan.toLowerCase().includes(search.value.toLowerCase())
    );
});
