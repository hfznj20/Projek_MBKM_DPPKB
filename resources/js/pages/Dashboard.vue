...
import Mapsebaran from './Mapsebaran.vue';
...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    <div class="mt-4">
      ...
      <div class="flex justify-center items-center rounded-b-xl overflow-hidden border border-sidebar-border/70 dark:border-sidebar-border p-4 bg-white dark:bg-sidebar">
  <Mapsebaran />
</div>
    </div>
