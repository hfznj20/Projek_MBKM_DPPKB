...
const filteredBumils = computed(() => {
  ...
  return bumils.value.filter((bumil) =>
    Object.values(bumil).some(value =>
    ...
    <div class="p-6">
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full border border-orange-500 rounded-lg">
          ...
          <tbody>
            <tr v-if="filteredBumils.length === 0" class="text-center text-gray-500">
              <td colspan="7" class="px-4 py-4 text-sm">Tidak ada data bumil.</td>
            </tr>
            <tr v-for="(bumil, index) in filteredBumils" :key="bumil.nik" class="border-t border-orange-500">
