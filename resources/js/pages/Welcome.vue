...
<div class="w-full flex justify-center mt-6 px-4">
  <div class="w-full max-w-3xl rounded-2xl overflow-hidden shadow-lg border-1 border-[#FF750F] bg-white p-2">
    ...
    <div class="text-center text-[#FF750F] font-semibold mt-3">
      Video Profil DPPKB Kota Parepare
        ...
        <div class="w-full border-1 border-[#FF750F] rounded-lg overflow-hidden bg-white shadow-lg flex flex-col">
          <!-- Profil -->
          <div class="w-full p-4 border-b-1 border-[#FF750F]">
            <h3 class="text-[#FF750F] text-lg font-semibold text-center">PROFIL</h3>
          </div>

          <!-- Ikon-ikon -->
          <div class="flex justify-around items-center p-4 bg-white border-b-1 border-[#FF750F]">
            <div class="flex flex-col items-center">
              <svg class="w-14 h-14 text-[#FF750F] mb-2" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span class="text-[#FF750F] text-base font-semibold">00000</span>
            </div>
            ...
            <div class="flex flex-col items-center">
              ...
              <span class="text-[#FF750F] text-base font-semibold">Jl. Jendral Sudirman No.107</span>
            </div>
            ...
            <a href="https://www.instagram.com/dppkbkotaparepare?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer">
              <div class="flex flex-col items-center">
                ...
                <span class="text-[#FF750F] text-base font-semibold">@dppkbkotaparepare</span>
              </div>
            </a>
            ...
            <div class="flex flex-col items-center">
              ...
              <span class="text-[#FF750F] text-base font-semibold">@dppkb</span>
            </div>
          </div>

          <!-- Map -->
          <div class="h-[300px] w-full border-t-1 border-[#FF750F] rounded-b-lg overflow-hidden">
